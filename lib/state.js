...
export function ensureSettings() {
    ...
    settings.onlyShow = typeof settings.onlyShow === 'boolean' ? settings.onlyShow : defaults.onlyShow;
    settings.includeInWorldInfoScanning = typeof settings.includeInWorldInfoScanning === 'boolean'
        ? settings.includeInWorldInfoScanning
        : defaults.includeInWorldInfoScanning;
